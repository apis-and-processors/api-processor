...
public @interface FallbackHandler {
    ...
    /**
     * Set class definition which extends AbstractFallbackHandler. Can
     * be used like so: @FallbackHandler(MyExtendingImpl.class);
     * 
     * @return AbstractFallbackHandler class. 
     */ 
